package be.lens.syntra.livecode.client.controller;

import be.lens.syntra.livecode.client.model.Book;
import be.lens.syntra.livecode.client.service.BookService;
...
public class BookController {
    ...
    public ModelAndView handleGetDetails(@PathVariable("isbn") String isbn){
